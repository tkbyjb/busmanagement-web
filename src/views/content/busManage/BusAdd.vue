          ...
          <el-form-item>
            <el-row>
              <el-col :span="16" :offset="8">
                <el-button type="primary" @click="$manage.add(vc, 'bus', form)"
                  >添加数据</el-button
                >
...
export default {
  data() {
    return {
      ...
      rules: {
        busName: [{ required: true, message: "请输入", trigger: "blur" }],
        busCode: [{ required: true, message: "请输入", trigger: "blur" }],
        engine: [{ required: true, message: "请输入", trigger: "blur" }],
        chassis: [{ required: true, message: "请输入", trigger: "blur" }],
        instrumentNumber: [
        ...
        pakingPlace: [{ required: true, message: "请输入", trigger: "blur" }],
        purpose: [{ required: true, message: "请输入", trigger: "blur" }],
        model: [{ required: true, message: "请输入", trigger: "blur" }],
        type: [{ required: true, message: "请输入", trigger: "blur" }],
        displace: [{ required: true, message: "请输入", trigger: "blur" }],
        purchaseDate: [{ required: true, message: "请输入", trigger: "blur" }],
      },
      fileList: [
