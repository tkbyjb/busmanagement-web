<template>
  <div>
    ...
    >
      ...
      <el-table-column prop="expId" label="记录id" width="120"></el-table-column>
    ...
    <el-card class="operate-container" shadow="never">
      <el-button size="small" type="success" class="btn-delete" style="margin-left: 20px"
        @click="set(2)"
        >通过</el-button>
        <el-button size="small"  type="warning" class="btn-delete" style="margin-left: 20px"
        @click="set(1)"
        >不通过</el-button>
        <el-button size="small" type="primary" class="btn-delete" style="margin-left: 20px"
        @click="set(0)"
        >待审核</el-button>
    </el-card>
...
export default {
  ...
  methods: {
      set(state) {
        this.$api.approve.set(this.selectRows, state)
        .then(response => {
